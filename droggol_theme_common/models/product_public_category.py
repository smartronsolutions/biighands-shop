...
class ProductPublicCategory(models.Model):
    ...
    dr_category_cover_image = fields.Binary('Category Cover Image')
    ...
    dr_search_formulate = fields.Boolean('Formulated Search', help="Use to search multi level categories \
        e.g. Men Shirt (Here men and shirt are different category but will be displayed as one in smart search)")
    ...
    def _get_search_db(self, website):
        search_db = self._get_category_search_tuples(self.env.context.get('lang'), website.id)
