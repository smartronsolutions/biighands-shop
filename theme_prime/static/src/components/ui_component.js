...
export class TpUiComponent extends AbstractComponent {
    ...
    get themePrimeConfig() {
        return this.props.extras._getDrthemeConfig();
    }
    get maxItemsLimit() {
        let themeConfig = this.themePrimeConfig;
        let { recordsLimit } = this.props.extras;
        return recordsLimit || themeConfig?.json_dynamic_snippet_config?.dr_snippets_max_item || 20;
    }
    get nodeOptions() {
